...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const dadosDoCurso = {
        ...
        "m3": { totalAulas: 0, cardGridBarraId: "prog-m3-card" }, "m4": { totalAulas: 0, cardGridBarraId: "prog-m4-card" },
        "m5": { totalAulas: 0, cardGridBarraId: "prog-m5-card" }, "m6": { totalAulas: 0, cardGridBarraId: "prog-m6-card" },
        "m7": { totalAulas: 0, cardGridBarraId: "prog-m7-card" }, "m8": { totalAulas: 0, cardGridBarraId: "prog-m8-card" },
        "m9": { totalAulas: 0, cardGridBarraId: "prog-m9-card" }, "m10": { totalAulas: 0, cardGridBarraId: "prog-m10-card" },
        "m11": { totalAulas: 0, cardGridBarraId: "prog-m11-card" }, "m12": { totalAulas: 0, cardGridBarraId: "prog-m12-card" },
        "m13": { totalAulas: 0, cardGridBarraId: "prog-m13-card" }, "m14": { totalAulas: 0, cardGridBarraId: "prog-m14-card" },
        "m15": { totalAulas: 0, cardGridBarraId: "prog-m15-card" }, "m16": { totalAulas: 0, cardGridBarraId: "prog-m16-card" },
        "m17": { totalAulas: 0, cardGridBarraId: "prog-m17-card" }, "m18": { totalAulas: 0, cardGridBarraId: "prog-m18-card" },
        "m19": { totalAulas: 0, cardGridBarraId: "prog-m19-card" }, "m20": { totalAulas: 0, cardGridBarraId: "prog-m20-card" },
        "m21": { totalAulas: 0, cardGridBarraId: "prog-m21-card" }, "m22": { totalAulas: 0, cardGridBarraId: "prog-m22-card" },
